		...
		try {
			SyncUtils.sync_index_struct(testClient, productClient, new SyncIndex() {
				...
				public boolean isSync(String index, String type) {
					...
					// return true;
					// }
					// if (index.equals("scm-info-productgoods1") ||
					// index.equals("scm-info-product1")
					// || index.equals("scm-info-goods1")) {
					// return true;
					// }
					// if (index.equals("release-goods-3") ||
					// index.equals("release-dealer-2")) {
					// return true;
					// }
					return false;
				}
